...
const getQueries_query = 'select id, question , email , isReplied,groupNo, reply , location , timestamp(timestamp) as timestamp from other_questions where isReplied = ? ORDER BY timestamp DESC ';
const getQueries_all = 'select id,question , email , isReplied,groupNo,reply , location , timestamp(timestamp) as timestamp from other_questions ORDER BY timestamp DESC';
